                        ...
                        <tbody>
                            @foreach($notifications as $index => $notification)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('employee.notifications.delete', $notification->id) }}" class="delete-btn" 
                                        onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this notification?')) { document.getElementById('delete-form-{{ $notification->id }}').submit(); }"><i class="fa fa-trash"></i></a>
                                        <form id="delete-form-{{ $notification->id }}" action="{{ route('employee.notifications.delete', $notification->id) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
